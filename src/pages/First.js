...
import topBg from '../assets/images/1-top.png';
import bottomBg from '../assets/images/1-bottom.png';
...
const First = () => {
    return (
        <div>
            <div>
                <img src={topBg} alt="top bg" style={{width: '100%', height: '230px'}} />
            </div>
            ...
            <div>
                <img src={bottomBg} alt="bottom bg" style={{width: '100%', height: '230px'}} />
            </div>
        </div>
    );
}
